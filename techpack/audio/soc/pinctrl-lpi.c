...
static int __init lpi_pinctrl_driver_init(void)
{
	return platform_driver_register(&lpi_pinctrl_driver);
}
late_initcall(lpi_pinctrl_driver_init);

static void __exit lpi_pinctrl_driver_exit(void)
{
	platform_driver_unregister(&lpi_pinctrl_driver);
}
module_exit(lpi_pinctrl_driver_exit);
